...
function WarningModal({ reason, onClose }) {
  const reasonLabels = { rightclick:"Klik kanan terdeteksi.", screenshot:"Percobaan screenshot terdeteksi.", copy:"Percobaan menyalin konten terdeteksi.", devtools:"Developer Tools terdeteksi.", keyboard:"Kombinasi tombol berbahaya terdeteksi." };
  return (
    <div style={{ position:"fixed", inset:0, zIndex:99999, display:"flex", alignItems:"center", justifyContent:"center", padding:"20px", backgroundColor:"rgba(0,0,0,0.82)", backdropFilter:"blur(8px)" }}>
      <div style={{ width:"100%", maxWidth:"420px", backgroundColor:"#12121f", border:"1.5px solid rgba(220,38,38,0.45)", borderRadius:"20px", padding:"36px 28px 28px", textAlign:"center", boxShadow:"0 32px 80px rgba(0,0,0,0.7)", animation:"modalIn 0.35s cubic-bezier(0.34,1.56,0.64,1) forwards" }}>
        ...
        <button onClick={onClose} style={{ width:"100%", padding:"14px", backgroundColor:"#dc2626", border:"none", borderRadius:"12px", color:"#fff", fontSize:"16px", fontWeight:"700", cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", gap:"8px" }}
          onMouseEnter={e => e.currentTarget.style.backgroundColor="#b91c1c"} onMouseLeave={e => e.currentTarget.style.backgroundColor="#dc2626"}>
      ...
      <div style={{ width:"100%", maxWidth:"460px", backgroundColor:"#1a2035", border:"1px solid rgba(255,255,255,0.08)", borderRadius:"20px", overflow:"hidden", boxShadow:"0 40px 80px rgba(0,0,0,0.6)", animation:"modalIn 0.3s cubic-bezier(0.34,1.56,0.64,1) forwards" }}>
        <div style={{ padding:"24px 24px 20px", borderBottom:"1px solid rgba(255,255,255,0.07)", display:"flex", alignItems:"flex-start", justifyContent:"space-between", gap:"12px" }}>
          ...
          <button onClick={onClose} style={{ background:"none", border:"none", cursor:"pointer", color:"#64748b", padding:"4px", borderRadius:"8px", display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0 }}
            onMouseEnter={e => e.currentTarget.style.color="#f8fafc"} onMouseLeave={e => e.currentTarget.style.color="#64748b"}>
...
function ProjectCard({ proj, idx, theme, darkMode, isMobile, isTablet }) {
  ...
  const isProject = proj.type === "project";

  // [PERUBAHAN 3] Tinggi thumbnail lebih besar di mobile/tablet agar tidak terpotong
  const thumbHeight = isMobile ? "220px" : isTablet ? "200px" : "180px";
  ...
  return (
    ...
    >
      ...
      {/* [PERUBAHAN 3] Thumbnail dengan tinggi adaptif dan object-fit: cover + objectPosition center */}
      <div style={{ width: "100%", height: thumbHeight, backgroundColor: darkMode ? "#0d1526" : "#e8edf5", overflow: "hidden", position: "relative", flexShrink: 0 }}>
        {hasThumbnail ? (
          ...
          <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "10px", background: darkMode ? "linear-gradient(135deg,#1e2a45,#0f1729)" : "linear-gradient(135deg,#dde6f5,#eef2f8)" }}>
        ...
        <span style={{
          ...
          padding: "3px 9px", borderRadius: "6px", backdropFilter: "blur(4px)",
          backgroundColor: isWebsite ? "rgba(37,99,235,0.85)" : isProject ? "rgba(139,92,246,0.85)" : "rgba(100,116,139,0.85)",
          color: "#fff",
        }}>
          {isWebsite ? "🌐 Website" : isProject ? "⚙️ Project" : "📁 Project"}
        </span>
      </div>
...
function CertCard({ cert, theme, darkMode, isMobile, isTablet }) {
  ...
  // [PERUBAHAN 3] Tinggi thumbnail sertifikat lebih besar di mobile/tablet
  const thumbHeight = isMobile ? "210px" : isTablet ? "190px" : "160px";
...
function App() {
  ...
  const techStack = {
    backend:  [{ name:"Laravel Core (PHP)", level:"Expert", color:"#3b82f6" },{ name:"Eloquent ORM & SQL", level:"Advanced", color:"#2563eb" },{ name:"RESTful API / Sanctum", level:"Advanced", color:"#60a5fa" },{ name:"FastAPI / Node.js", level:"Intermediate", color:"#1d4ed8" }],
    frontend: [{ name:"Inertia.js & React", level:"Advanced", color:"#3b82f6" },{ name:"Livewire & Blade", level:"Expert", color:"#2563eb" },{ name:"Tailwind CSS", level:"Expert", color:"#60a5fa" },{ name:"TypeScript", level:"Advanced", color:"#1d4ed8" }],
  };
  ...
  const projectsData = [
    {
      title:"Website OSIM MAN 1 Medan",
      desc:"Website resmi OSIM MAN 1 Medan yang menyajikan informasi terkini tentang siswa/siswi MAN 1 Medan.",
      tech:["HTML","CSS","Website"],
      type:"website",
      link:"https://osimman1medan.vercel.app/",
      img:"osim.png",
    },
    {
      title:"Sistem Monitoring Kelas",
      desc:"Aplikasi untuk memonitoring kehadiran dan aktivitas mahasiswa di dalam kelas secara real-time.",
      tech:["FastAPI","SQLServer","PHP"],
      type:"project",
      link:null,
      img:"sistem.jpeg",
    },
    {
      title:"Proyek Penjualan",
      desc:"Sistem informasi untuk mengelola penjualan produk secara efisien dan efektif.",
      tech:["React Client","PHP","MySQL"],
      type:"website",
      link:"https://proyekpenjualan.infinityfreeapp.com/",
      img:"proyekpenjualan.jpeg",
    },
    {
      title:"Analisis Kelulusan Mahasiswa",
      desc:"Sistem untuk menganalisis data kelulusan mahasiswa berdasarkan berbagai faktor akademik.",
      tech:["Laragon","Mathlab","Streamlit","Python"],
      type:"project",
      link:null,
      img:"streamlit.png",
    },
  ...
  return (
    <div style={{ margin:0, fontFamily:"'Plus Jakarta Sans','Inter',sans-serif", color:theme.text, minHeight:"100vh", backgroundColor:theme.bg, overflowX:"hidden", position:"relative", transition:"background-color 0.3s ease, color 0.3s ease" }}>
      ...
      <style>{`
        * { box-sizing:border-box; }
        ...
        @media (max-width:1023px) {
          ...
          /* [PERUBAHAN 1] Teks "Halo, Saya Alif..." rata KIRI di mobile/tablet */
          .hero-desc-text {
        ...
        /* [PERUBAHAN 2] Contact heading rata kiri di semua ukuran (sudah di inline style) */
      ...
      <div style={{ position:"relative", zIndex:1 }}>
        ...
        <div id="profile" style={{ position:"relative", width:"100%" }}>
          ...
          <section style={{ display:"grid", gridTemplateColumns:heroGrid, gap:0, maxWidth:"1150px", margin:"0 auto", padding:heroPad, alignItems:"center", position:"relative", zIndex:1 }}>
            ...
            {/* Photo column */}
            <div className="hero-photo-col" style={{ display:"flex", justifyContent:isMobileOrTablet?"center":"center", marginBottom:isDesktop?0:"28px" }}>
            ...
            <div className="hero-content-col" style={{ display:"flex", flexDirection:"column", alignItems:isMobileOrTablet?"center":"flex-start" }}>
              ...
              {/* [PERUBAHAN 1] Deskripsi hero — rata KIRI di mobile/tablet */}
              <p className="hero-desc-text" style={{
                fontSize: isMobile?"14px":"15px",
                color: theme.subText,
                lineHeight: "1.7",
                margin: "0 0 32px 0",
                // Default desktop: rata kiri. Override mobile/tablet via CSS class
                textAlign: "left",
                alignSelf: "auto",
                maxWidth: "100%"
              }}>
        ...
        <section id="projects" style={{ padding:sectionPad, backgroundColor:darkMode?"transparent":theme.sectionAlt, borderBottom:`1px solid ${theme.border}` }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:isMobile?"1fr":isTablet?"repeat(2,1fr)":"repeat(2,1fr)", gap:"20px", maxWidth:"900px", margin:"0 auto" }}>
            {projectsData.map((proj, i) => (
              <div key={i} className={`scroll-animate scroll-delay-${Math.min(i+1,4)}`}>
                <ProjectCard proj={proj} idx={i} theme={theme} darkMode={darkMode} isMobile={isMobile} isTablet={isTablet} />
              </div>
            ))}
          </div>
        </section>
        ...
        {/* TECH SCROLL */}
        <section style={{
          background: darkMode ? "#1a2335" : "#e0e8f4",
          padding:"44px 0 36px",
          overflow:"hidden",
          borderTop:`1px solid ${darkMode?"rgba(255,255,255,0.06)":"#b8cce0"}`,
          borderBottom:`1px solid ${darkMode?"rgba(255,255,255,0.06)":"#b8cce0"}`,
        }}>
        ...
        <section id="sertifikat" style={{ padding:sectionPad, backgroundColor:darkMode?"transparent":theme.cardBg, borderBottom:`1px solid ${theme.border}` }}>
          <div className="scroll-animate" style={{ textAlign:"center", marginBottom:"36px" }}>
            ...
            <p style={{ color:"#64748b", margin:"0 auto", fontSize:"14px", maxWidth:"560px" }}>
              Kumpulan sertifikat standar keahlian dan kualifikasi teknis yang saya miliki.
            </p>
          </div>
        ...
        {/* CONTACT */}
        {/* [PERUBAHAN 2] Heading "Tertarik untuk berkolaborasi!" sudah rata kiri secara natural karena flex-direction column + align-items flex-start pada container */}
        <section id="contact" style={{ padding:isMobile?"60px 28px":isTablet?"70px 48px":"80px 10%", backgroundColor:darkMode?"#1a2744":theme.sectionAlt, borderTop:`1px solid ${theme.border}`, display:"flex", flexDirection:isMobile?"column":"row", alignItems:isMobile?"flex-start":"center", justifyContent:"space-between", gap:"40px" }}>
          <div style={{ flex:1, maxWidth:"560px" }}>
            ...
            {/* [PERUBAHAN 2] textAlign: "left" diterapkan secara eksplisit */}
        ...
        <footer style={{ padding:isMobile?"16px 20px":"18px 10%", backgroundColor:theme.cardBg, borderTop:`1px solid ${theme.border}`, display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:"8px", userSelect:"none", WebkitUserSelect:"none" }}>
          <span style={{ fontSize:"13px", color:darkMode?"#94a3b8":"#64748b", fontWeight:"500", opacity:1, visibility:"visible" }}>© 2026 M. Alif Ramadhan. Dibuat dengan <span style={{ color:darkMode?"#a78bfa":"#7c3aed", fontWeight:"700" }}>☕</span> dan <span style={{ color:"#2563eb", fontWeight:"700" }}>&lt;/&gt;</span>.</span>
          <LiveClock />
        </footer>
      </div>
    </div>
